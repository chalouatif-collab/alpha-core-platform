...
def init_db():
    ...
    # 1. جدول المستخدمين المطور بدعم الرتب والوكيل
    cursor.execute("""
    ...
    # 4. جدول المعاملات المالية الموحد
    cursor.execute("""
    ...
    # حقن حساب الـ Super Owner الافتراضي (fethi) لو غير موجود
...
# --- نماذج البيانات الممررة (المسافات مضبوطة بدقة هنا) ---
...
# --- مسارات الإدارة والشحن الهرمي المحمي ---
